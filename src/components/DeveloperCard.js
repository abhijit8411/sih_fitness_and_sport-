  ...
  return (
    <div id="dev" className="absolute top-[2556px] left-[0px] bg-black w-screen h-[636px] overflow-hidden flex flex-col pt-[120px] px-[120px] pb-[138px] box-border items-center justify-center gap-[10px] text-center text-31xl text-white font-leading-tight-text-sm-font-normal">
      ...
      <div className="w-[1091px] h-[257px] m-8 flex flex-row flex-wrap items-center justify-between text-[31.74px]">
        <ContainerCardForm productDimensions="/vector.svg" name="Abhijit" person={sb} />
        <ContainerCardForm productDimensions="/vector1.svg" name="Ravindra" person={sg} />
        <ContainerCardForm productDimensions="/vector2.svg" name="Vijay" person={rm} />
        <ContainerCardForm productDimensions="/vector3.svg" name="Rushikesh" person={js} />
        <ContainerCardForm productDimensions="/vector5.svg" name="Shreyash" person={rav} />
        <ContainerCardForm productDimensions="/vector4.svg" name="Sanika" person={km} />
      </div>
    </div>
  );
};
