...
const API = process.env.REACT_APP_API || "https://sih-fitness-app-api.onrender.com";
...
const exerciseInstructions = {
  ...
  squats: {
    ...
    instructions: [
      ...
      "Keep your chest up and back straight. Go as low as comfortable, then push through your heels to return to standing.",
    ],
  },
  pushups: {
    title: "Push Ups",
    instructions: [
      ...
      "Push back up to the starting position while keeping your core tight and body in a straight line.",
    ],
  },
  crunches: {
    title: "Crunches",
    instructions: [
      ...
      "Curl your upper body toward your knees, engaging your abs. Slowly lower back down with control.",
    ],
  },
};
...
function TrainGround() {
  ...
  // If no exercise param, redirect to main dashboard
  useEffect(() => {
    if (!exercise || !exrInfo[exercise]) {
      navigate("/main");
    }
  }, [exercise, navigate]);
  ...
  function onResult(results) { 
    if (!exercise || !exrInfo[exercise]) return;
  ...
  // Don't render if exercise is invalid
  if (!exercise || !exrInfo[exercise]) {
    return null;
  }

  const currentInstructions = exerciseInstructions[exercise];
    ...
    <div className="flex flex-col justify-center items-center ">
      ...
      ">
        ...
        >
          ...
          <p>
              {
                currentInstructions ? currentInstructions.instructions.map((instruction, index) => {
